...
|?
|If we forward calls to other contracts, how is the total amount of required gas calculated? Would https://consensys.github.io/smart-contract-best-practices/known_attacks/#insufficient-gas-griefing[gas griefing] attacks be possible?
